...
const normalizeEmail = (value) => clean(value, 240).toLocaleLowerCase('en-US');

const authenticatedIdentity = (request, env) => {
...
const projectIdentity = (request, env, state) => {
...
const stateForRole = (state, identity) => {
...
const mergeStateForRole = (previous, incoming, identity) => {
  const role = identity.role;

...
import { synchronizeDerivedProgress } from './progress.ts';
...
const keyedCollections: KeyedCollection[] = [
  'budgetLines', 'financeEntries', 'procurement', 'counterparties', 'supplierQuotes', 'leads',
  'tasks', 'fieldReports', 'checkpoints', 'documents', 'decisions',
];

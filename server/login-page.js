...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}body{margin:0;min-height:100vh;min-height:100dvh;display:grid;place-items:center;padding:24px;background:radial-gradient(circle at 15% 10%,#fff 0,transparent 34%),linear-gradient(145deg,#eef1eb,#f7f7f4)}
    ...
    @media(max-width:520px){body{padding:max(20px,env(safe-area-inset-top)) 16px max(20px,env(safe-area-inset-bottom));align-items:center}.card{padding:26px 22px;border-radius:22px}.brand{margin-left:2px}h1{font-size:28px}}
  </style>
</head>
<body>
  <main class="shell">
